...
| Запрос невалидного SellerID | SellerID в диапазоне меньше значения 111111 | Отправить GET запрос {{baseUrl}}/api/1/111110/item | 400 Bad Request | Failed
| Запрос невалидного SellerID | SellerID в диапазоне больше значения 999999 | Отправить GET запрос {{baseUrl}}/api/1/1000000/item | 400 Bad Request | Failed
| Запрос невалидного SellerID | SellerID равен 0 | Отправить GET запрос {{baseUrl}}/api/1/0/item | 400 Bad Request | Failed
| Запрос невалидного SellerID | SellerID равен -1 | Отправить GET запрос {{baseUrl}}/api/-1/0/item | 400 Bad Request | Failed
